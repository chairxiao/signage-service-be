...
{
    public partial class SurfGrmcMulHour
    {
        ...
        public string BMaxTime { get; set; }
        public double? BMin { get; set; }
        public string BMinTime { get; set; }
        public double? D { get; set; }
        public double? DMax { get; set; }
        public string DMaxTime { get; set; }
        public double? DMin { get; set; }
        public string DMinTime { get; set; }
        ...
        public double? D160 { get; set; }
        public double? D320 { get; set; }
        ...
        public string VMinTime { get; set; }
        public string RMinute { get; set; }
