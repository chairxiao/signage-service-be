...
namespace Signage.Service
{
    public class DownloadService : ISingletonDependency
    {
        ...
        public DownloadService(InfoplayConfig infoplayConfig, DownloadServiceConfig downloadServiceConfig)
        {
            _infoplayConfig = infoplayConfig;

            DownloadServiceItem.infoplayConfig = infoplayConfig;
            DownloadServiceItem.downloadServiceConfig = downloadServiceConfig;
        }
        ...
        {
            foreach(var di in downloadServiceItem_Repo.Values)
            {
                var rc = di.DownloadAsync().Result;
            }
