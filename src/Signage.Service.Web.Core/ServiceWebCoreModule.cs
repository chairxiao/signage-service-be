...
using Signage.Service.Authentication.JwtBearer;
...
namespace Signage.Service
{
    ...
    public class ServiceWebCoreModule : AbpModule
    {
        ...
        public ServiceWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                 .CreateControllersForAppServices(
                     typeof(ServiceApplicationModule).GetAssembly()
                 );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ServiceWebCoreModule).GetAssembly());
        }
    }
}
